      ...
      <div className='flex flex-col justify-start items-center gap-2 overflow-y-auto h-48'>
        {
          visitedProfiles.map((profile, index) => {
            return (
              <Link style={{ borderWidth: '1px' }} key={index} className='flex justify-start hover:bg-sky-800 hover:text-white hover:border-transparent rounded-md p-1 border-gray-300 w-72' href={`/player/${profile.profileId}/page/1`}>
