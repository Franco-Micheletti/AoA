      ...
      <div className='flex flex-wrap p-3 gap-2 justify-center items-center max-w-3xl'>
        {
          playerList.map(player => {
            return (
              <Link className='flex cursor-pointer justify-start items-center bg-white hover:bg-sky-700 text-cyan-800 hover:text-white rounded-md w-72 shadow-sm' href={`/player/${player.members[0].profile_id}/page/1`}>
